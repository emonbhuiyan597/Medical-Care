          ...
          <div>
            <div className="lg:w-[570px]">
                    ...
                    <p className="text__para">
                      Lorem, ipsum dolor sit amet consectetur adipisicing elit. Laboriosam voluptas quibusdam esse eaque minima voluptatem. Perferendis, quas tempore similique rem atque deleniti quidem ipsum, voluptatem quod placeat animi, hic qui?
                    </p>
                ...
                <div className="container">
                 ...
                 <div className="py-[30px] px-5 ">
                    ...
                    <div className="mt[30px]  ">
                      ...
                      <p className="text-[16px] leading-7 text-textColor font-[400] mt-4 text-center " > World-class care care for everyone. Our health System offers unmatched, expert health care, From the lab to the clinic.
                      </p>
                         ...
                         <Link to={'/'}>
                          <button className="btn">Learn More</button>
                             ...
                             <div className="flex items-center gap-[6px] lg:gap-[10px] mt-2 lg:mt-[18px]">
                              ...
                              <h4 className="text-[10px] leading-3 lg:text-[16px] leading-[22px] font-[700] text-headingColor">Wayne Collins </h4>
                             </div>
                ...
                <div className="container">
                  <div className="flex justify-between gap-[50px] lg:gap-0">
                    ...
                    <div className="w-full md:w-1/2">
                      <h2 className="heading">Most Question By Our Beloved Paitens</h2>
